...
void lv_tutorial_objects(void)
{
	...
	style.text.font = &lv_font_dejavu_30;   /*Unicode and symbol fonts already assigned by the library*/
    ...
    lv_page_set_style(scr,LV_PAGE_STYLE_BG,&lv_style_pretty_color);
    lv_scr_load(scr);
